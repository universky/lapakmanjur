        ...
        return function (str) {
            return str
                .replace(camelRegex, function (letter, index) {
                    return letter[
                        index === 0 ? "toLowerCase" : "toUpperCase"
                    ]();
                })
                .replace(whiteSpace, "");
        };
        ...
        fn["outer" + v] = function (margins) {
            return (
                ...
                (margins
                    ? compute(
                          this,
                          "margin" + (v === "Width" ? "Left" : "Top")
                      ) +
                      compute(
                          this,
                          "margin" + (v === "Width" ? "Right" : "Bottom")
                      )
                    : 0)
            );
        };
    ...
    fn.extend({
        ...
        find: function (selector) {
            if (!selector || selector.nodeType) {
                return cash(
                    selector && this.has(selector).length ? selector : null
                );
            }
    ...
    var Collapsible = (function (_Component) {
        ...
        function Collapsible(el, options) {
            ...
            var _this3 = _possibleConstructorReturn(
                ...
                ).call(this, Collapsible, el, options)
            );
                    ...
                    value: function _handleCollapsibleClick(e) {
                        ...
                        if (e.target && $header.length) {
                            ...
                            if ($collapsible[0] === this.el) {
                                ...
                                var $collapsibleLis =
                                    $collapsible.children("li");
                                var isActive =
                                    $collapsibleLi[0].classList.contains(
                                        "active"
                                    );
                                var index =
                                    $collapsibleLis.index($collapsibleLi);
                ...
                },
                {
                    ...
                    value: function _animateIn(index) {
                        ...
                        if ($collapsibleLi.length) {
                            var $body =
                                $collapsibleLi.children(".collapsible-body");
                            ...
                            anim({
                                ...
                                complete: function (anim) {
                                    ...
                                    // onOpenEnd callback
                                    if (
                                        typeof _this6.options.onOpenEnd ===
                                        "function"
                                    ) {
                                        _this6.options.onOpenEnd.call(
                                            _this6,
                                            $collapsibleLi[0]
                                        );
                                    }
                        ...
                        if ($collapsibleLi.length) {
                            ...
                            anim({
                                ...
                                complete: function () {
                                    ...
                                    // onCloseEnd callback
                                    if (
                                        typeof _this7.options.onCloseEnd ===
                                        "function"
                                    ) {
                                        _this7.options.onCloseEnd.call(
                                            _this7,
                                            $collapsibleLi[0]
                                        );
                                    }
                    ...
                    value: function init(els, options) {
                        return _get(
                            Collapsible.__proto__ ||
                                Object.getPrototypeOf(Collapsible),
                            "init",
                            this
            ...
            [
                ...
                },
                {
                    ...
                    value: function _getDropdownPosition() {
                        ...
                        var closestOverflowParent = !!this.dropdownEl
                            .offsetParent
                        ...
                        if (!alignments.top) {
                            if (alignments.bottom) {
                                ...
                                if (
                                    alignments.spaceOnTop >
                                    alignments.spaceOnBottom
                                ) {
                                    verticalAlignment = "bottom";
                        ...
                        if (!alignments[horizontalAlignment]) {
                            ...
                            if (alignments[oppositeAlignment]) {
                                ...
                                // Determine which side has most space and cutoff at correct height
                                if (
                                    alignments.spaceOnLeft >
                                    alignments.spaceOnRight
                                ) {
                    ...
                    value: function _animateIn() {
                        ...
                        anim({
                            ...
                            complete: function (anim) {
                                ...
                                // onOpenEnd callback
                                if (
                                    typeof _this11.options.onOpenEnd ===
                                    "function"
                                ) {
                    ...
                    value: function _animateOut() {
                        ...
                        anim({
                            ...
                            complete: function (anim) {
                                ...
                                // onCloseEnd callback
                                if (
                                    typeof _this12.options.onCloseEnd ===
                                    "function"
                                ) {
                                    var elem = anim.animatables[0].target;
            ...
            [
                {
                    ...
                    value: function init(els, options) {
                        return _get(
                            Dropdown.__proto__ ||
                                Object.getPrototypeOf(Dropdown),
                            "init",
                            this
                        ).call(this, this, els, options);
                    },
                ...
                },
                {
                    ...
                    value: function _animateIn() {
                        ...
                        var enterAnimOptions = {
                            ...
                            complete: function () {
                                if (
                                    typeof _this14.options.onOpenEnd ===
                                    "function"
                                ) {
                    ...
                    value: function _animateOut() {
                        ...
                        var exitAnimOptions = {
                            ...
                            complete: function () {
                                ...
                                if (
                                    typeof _this15.options.onCloseEnd ===
                                    "function"
                                ) {
            ...
            [
                {
                    ...
                    value: function init(els, options) {
                        return _get(
                            Parallax.__proto__ ||
                                Object.getPrototypeOf(Parallax),
                            "init",
                            this
                        ).call(this, this, els, options);
                    },
                    ...
                    value: function _setupSwipeableTabs() {
                        ...
                        this._tabsCarousel = M.Carousel.init($tabsWrapper[0], {
                            ...
                            onCycleTo: function (item) {
                                ...
                                if (
                                    typeof _this25.options.onShow === "function"
                                ) {
        ...
        _createClass(
            ...
            [
                ...
                },
                {
                    ...
                    value: function _repositionWithinScreen(
                        x,
                        y,
                        width,
                        height
                        ...
                        var edges = M.checkWithinContainer(
                            document.body,
                            bounding,
                            offset
                        );
            ...
            [
                ...
                },
                {
                    ...
                    value: function _handleCloseTriggerClick(e) {
                        var $closeTrigger = $(e.target).closest(
                            ".sidenav-close"
                        );
                    ...
                    value: function _animateSidenavIn() {
                        ...
                        anim({
                            ...
                            complete: function () {
                                ...
                                if (
                                    typeof _this32.options.onOpenEnd ===
                                    "function"
                                ) {
                    ...
                    value: function _animateSidenavOut() {
                        ...
                        anim({
                            ...
                            complete: function () {
                                // Run onOpenEnd callback
                                if (
                                    typeof _this33.options.onCloseEnd ===
                                    "function"
                                ) {
            ...
            [
                ...
                },
                {
                    ...
                    value: function _handleTriggerClick(e) {
                        ...
                        for (
                            var i = ScrollSpy._elements.length - 1;
                            i >= 0;
                            i--
                        ) {
                ...
                },
                {
                    ...
                    value: function _exit() {
                        ...
                        if (ScrollSpy._visibleElements[0]) {
                            ...
                            ScrollSpy._visibleElements =
                                ScrollSpy._visibleElements.filter(function (
                                    el
                                ) {
                                    return (
                                        el.attr("id") != _this36.$el.attr("id")
                                    );
                                });
                            if (ScrollSpy._visibleElements[0]) {
                                // Check if empty
...
(function ($) {
    ...
    M.textareaAutoResize = function ($textarea) {
        ...
        if ($textarea.data("original-height") <= hiddenDiv.innerHeight()) {
            ...
            $textarea[0].value.length < $textarea.data("previous-length")
        ) {
            /**
                    ...
                    value: function render(year, month, randId) {
                        ...
                        for (var i = 0, r = 0; i < cells; i++) {
                            var day = new Date(year, month, 1 + (i - before)),
                                ...
                                hasEvent =
                                    opts.events.indexOf(day.toDateString()) !==
                                    -1
                                        ? true
                                        : false,
                ...
                },
                {
                    ...
                    value: function _setupVariables() {
                        ...
                        this.formats = {
                            ...
                            yy: function () {
                                return ("" + _this56.date.getFullYear()).slice(
                                    2
                                );
                            },
                            yyyy: function () {
                ...
                },
                {
                    ...
                    value: function _setupModal() {
                        ...
                        this.modal = M.Modal.init(this.modalEl, {
                            ...
                            onCloseEnd: function () {
                                if (
                                    typeof _this59.options.onCloseEnd ===
                                    "function"
                                ) {
            ...
            [
                    ...
                    value: function _handleResize(e) {
                        if (this.options.fullWidth) {
                            ...
                            this.imageHeight = this.$el
                                ...
                                .height();
                            this.dim =
                                this.itemWidth * 2 + this.options.padding;
                ...
                },
                {
                    ...
                    value: function _setCarouselHeight(imageOnly) {
                        ...
                        var firstSlide = this.$el.find(".carousel-item.active")
                            .length
                        ...
                        if (firstImage.length) {
                            if (firstImage[0].complete) {
                                ...
                                if (imageHeight > 0) {
                                    ...
                                    var naturalWidth =
                                        firstImage[0].naturalWidth;
                                    var naturalHeight =
                                        firstImage[0].naturalHeight;
                                    var adjustedHeight =
                ...
                },
                {
                    ...
                    value: function _autoScroll() {
                        ...
                        if (this.amplitude) {
                            ...
                            delta =
                                this.amplitude *
                                Math.exp(-elapsed / this.options.duration);
                            if (delta > 2 || delta < -2) {
                    ...
                    value: function _scroll(x) {
                        ...
                        for (i = 1; i <= half; ++i) {
                            ...
                            if (this.options.fullWidth) {
                                ...
                                zTranslation =
                                    this.options.dist * (i * 2 + tween * dir);
                                tweenedOpacity =
                                    1 -
                                    numVisibleOffset * (i * 2 + tween * dir);
                            }
                            // Don't show wrapped items.
            ...
            [
                {
                    ...
                    value: function init(els, options) {
                        return _get(
                            Carousel.__proto__ ||
                                Object.getPrototypeOf(Carousel),
                            "init",
                            this
                        ).call(this, this, els, options);
                    },
    ...
    var FormSelect = (function (_Component20) {
        ...
        function FormSelect(el, options) {
            ...
            var _this68 = _possibleConstructorReturn(
                ...
                ).call(this, FormSelect, el, options)
            );
        ...
        _createClass(
            ...
            [
                    ...
                    value: function _setupEventHandlers() {
                        ...
                        $(this.dropdownOptions)
                            ...
                            .each(function (el) {
                                el.addEventListener(
                                    "click",
                                    _this69._handleOptionClickBound
                                );
                            });
                        this.el.addEventListener(
                            "change",
                ...
                },
                {
                    ...
                    value: function _handleOptionClick(e) {
                        ...
                        if (
                            ...
                            var prevSelected = $(this._valueDict[key].el).prop(
                                "selected"
                            );
                            if (prevSelected !== selected) {
                                $(this._valueDict[key].el).prop(
                                    "selected",
                                    selected
                                );
                                this.$el.trigger("change");
                        ...
                        if (!this.el.disabled) {
                            ...
                            dropdownOptions.onOpenEnd = function (el) {
                                var selectedOption = $(_this71.dropdownOptions)
                                    ...
                                    .first();
                                if (
                                    _this71.dropdown.isScrollable &&
                                    selectedOption.length
                                ) {
                                    var scrollOffset =
                                        selectedOption[0].getBoundingClientRect()
                                            .top -
                                        _this71.dropdownOptions.getBoundingClientRect()
                                            .top; // scroll to selected option
                                    scrollOffset -=
                                        _this71.dropdownOptions.clientHeight /
                                        2; // center in dropdown
                                    _this71.dropdownOptions.scrollTop =
                                        scrollOffset;
                                }
                            };
                ...
                },
                {
                    ...
                    value: function _appendOptionWithIcon(
                        select,
                        option,
                        type
                    ) {
                ...
                },
                {
                    ...
                    value: function _setValueToInput() {
                        ...
                        if (!values.length) {
                            var firstDisabled = this.$el
                                .find("option:disabled")
                                .eq(0);
                            if (
                                firstDisabled.length &&
                                firstDisabled[0].value === ""
                            ) {
                ...
                },
                {
                    ...
                    value: function _setSelectedStates() {
                        ...
                        for (var key in this._valueDict) {
                            ...
                            var optionIsSelected = $(option.el).prop(
                                "selected"
                            );
                            $(option.optionEl)
                                .find('input[type="checkbox"]')
            ...
            [
                {
                    ...
                    value: function init(els, options) {
                        return _get(
                            FormSelect.__proto__ ||
                                Object.getPrototypeOf(FormSelect),
                            "init",
                            this
                        ).call(this, this, els, options);
                    },
            ...
            [
                ...
                },
                {
                    ...
                    value: function _calcRangeOffset() {
                        ...
                        var percent =
                            (parseFloat(this.$el.val()) - min) / (max - min);
