...
<script>
    let app = new Vue({
        el: '#app',
        data: {
            keterampilan: '{{$skill_language->keterampilan}}',
            bahasa: '{{$skill_language->bahasa}}',
            created_at: '',
            updated_at: '',
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/skill_language/{{$skill_language->id}}', {
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            title: 'Berhasil',
                            text: 'Data Keterampilan dan Bahasa berhasil diperbaharui.',
                            icon: 'success',
