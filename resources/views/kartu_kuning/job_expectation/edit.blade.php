...
<script>
    ...
    let app = new Vue({
        el: '#app',
        data: {
            penempatan: '{{$job_expectation->penempatan}}',
            provinsi_harapan: '{{$job_expectation->provinsi_harapan}}',
            kab_harapan: '{{$job_expectation->kab_harapan}}',
            min_gaji_harapan: '{{$job_expectation->min_gaji_harapan}}',
            created_at: '',
            updated_at: '',
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/job_expectation/{{$job_expectation->id}}', {
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            title: 'Berhasil',
                            text: 'Data Pekerjaan Harapan berhasil diperbaharui.',
                            icon: 'success',
