                                                        ...
                                                        <tr>
                                                            <div class="row">
                                                                ...
                                                                <div class="col s1">
                                                                    ...
                                                                    <span class="mb-7 btn waves-effect waves-light cyan" v-on:click="addRow"><i class="material-icons">add</i></span>
                                                                    <!-- </th> -->
                                                                </div>
                                                            </div>
                                                        </tr>
...
<script>
    let app = new Vue({
        ...
        data: {
            ...
            experienceList: JSON.parse('{!! $experiences !!}'),
            i: 0,
        ...
        methods: {
            ...
            submitForm: function() {
                // console.log(this.experienceList.length)
                for (this.i = 0; this.i >= this.experienceList.length; this.i++) {
                    console.log(this.experienceList[this.i]['nama_perusahaan'])
                }
            ...
            sendData: function() {
                ...
                axios.patch('/experience/{{$id}}', {
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            title: 'Berhasil',
                            text: 'Data Pengalaman berhasil diperbaharui.',
                            icon: 'success',
