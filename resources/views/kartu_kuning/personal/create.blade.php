                                    ...
                                    <form @submit.prevent="submitForm" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="input-field col s6">
                                                ...
                                                <label style="color: black;" for="nik">NIK <span style="color:red;">(*harus diisi 16 digit angka)</span></label>
                                            </div>
                                            <div class="input-field col s6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col s6">
                                                ...
                                                <div class="file-field input-field">
                                                    <div class="btn">
                                                        <span>Pilih File</span>
                                                        <input type="file" ref="ijazah" class="custom-file-input" accept=".pdf" v-on:change="handleIjazahUpload">
                                                    </div>
                                                    <div class="file-path-wrapper">
                                                        <input class="file-path validate" type="text">
                                                    </div>
