            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 l6">
                        <h5 class="breadcrumbs-title"><span>Detail Lamaran Kerja</span></h5>
                    </div>
                    <div class="col s12 m6 l6 right-align-md">
                        <ol class="breadcrumbs mb-0">
                            <!-- <li class="breadcrumb-item"><a href="/home">Home</a>
                            </li> -->
                            <li class="breadcrumb-item"><a href="/application">Kembali</a>
                            </li>
                ...
                <div class="section users-view">
                                ...
                                <div class="display-flex media">
                                    ...
                                    <div class="media-body">
                                        <h6 class="media-heading">
                                            <span class="users-view-name">{{$personal!=""?$personal->nama_lengkap:""}}</span>
                                        </h6>
                                        <span>NIK:</span>
                                        <span class="users-view-id">{{$kartu_kuning!=""?$kartu_kuning->nik:""}}</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="reject" class="modal modal-fixed-footer" style="width: 600px; height:400px; border-radius: 25px;">
                                        <form @submit.prevent="submitReject">
                                            <div class="modal-content">
                                                <h5>Reject Lamaran</h5>
                                                <br>
                                                <p>Apakah anda yakin untuk menolak permohonan Lamaran Pekerjaan atas nama {{$personal->nama_lengkap}} dengan NIK {{$personal->nik}}?</p>
                                                <div class="row">
                                ...
                                <?php } else if ($application->status == "Rejected") { ?>
                                    ...
                                    <div id="approve" class="modal modal-fixed-footer" style="width: 600px; height:400px; border-radius: 25px;">
                                        <form @submit.prevent="submitApprove">
                                            <div class="modal-content">
                                                <h5>Approve Lamaran</h5>
                                                <br>
                                                <p>Apakah anda yakin untuk menyetujui permohonan Lamaran Pekerjaan atas nama {{$kartu_kuning->nama_lengkap}} dengan NIK {{$kartu_kuning->nik}}?</p>
                                                <div class="row">
                                                    <div class="input-field col s12">
                                                        <input type="text" placeholder="Masukkan Alasan" v-model="alasan" required>
                                                        <label for="alasan">Alasan</label>
                                ...
                                <div class="col s12 m12">
                                    <table class="striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Tgl. Lamar Kerja:</td>
                                                <td>{{ $kartu_kuning->date }}</td>
                                            </tr>
                                            <tr>
                                                <td>Status:</td>
                                                <?php if ($application->status == "Approved") { ?>
                                                    <td><span class=" users-view-status chip green lighten-5 green-text">{{ $application->status }}</span></td>
                                                <?php } else if ($application->status == "Rejected") { ?>
                                                    <td><span class=" users-view-status chip red lighten-5 red-text">{{ $application->status }}</span></td>
                                                <?php } else { ?>
                                                    <td><span class=" users-view-status chip blue lighten-5 blue-text">{{ $application->status }}</span></td>
                                                <?php } ?>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="row indigo lighten-5 border-radius-4 mb-2">
                                <div class="col s6 m6 users-view-timeline">
                                    <h6 class="indigo-text m-0">Informasi Pelamar</h6>
                                </div>
                                ...
                                <div class="col s6 m6 users-view-timeline">
                                    <div class="col s12 m12 m-0 quick-action-btns display-flex justify-content-end align-items-center pt-2">
                                        ...
                                        <a class="btn cyan waves-effect waves-light" href="/application/detail_pelamar/{{$application->id}}">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="row indigo lighten-5 border-radius-4 mb-2">
                                <div class="col s6 m6 users-view-timeline">
                                    <h6 class="indigo-text m-0">Informasi Pekerjaan</h6>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col s8 m8">
                                    <table class="striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Jam Kerja:</td>
                                                <td> {{$job!=""?$job->jam_kerja:""}}</td>
                                            </tr>
                                            <tr>
                                                <td>Gaji:</td>
                                                <td> {{$job!=""?$job->gaji1:""}} - {{$job!=""?$job->gaji2:""}}</td>
                                            </tr>
                                            <tr>
                                                <td>Pengalaman:</td>
                                                <td class="users-view-latest-activity">{{$job!=""?$job->pengalaman:""}}</td>
                                            </tr>
                                            <tr>
                                                <td>Tanggal dibuat:</td>
                                                <td class="users-view-verified">{{$job!=""?$job->tgl_buat:""}}</td>
                                            </tr>
                                    ...
                                    <p>
                                        <span>&#8226;&ensp;</span>{{$job!=""?$job->kemampuan_wajib:""}}
                                    </p>
                                    <br>
                                    <h6>Kemampuan Tambahan</h6>

                                    <p>
                                        <span>&#8226;&ensp;</span>{{$job!=""?$job->kemampuan_tambahan:""}}
                                    </p>
                                    <br>
                                    ...
                                    <p>
                                        <span>&#8226;&ensp;</span>{{$job!=""?$job->deskripsi:""}}
                                    </p>
                                    <br>
                                </div>
                                <div class="col s4 m4">
                                    <h5 class="mt-0">{{$job->companies->name}} - {{$job->companies->industri}}</h5>
                                    <p>{{$job->companies->lokasi}}</p>
                                    ...
                                    <hr>
                                    <p class="mt-2"><b class="blue-grey-text text-darken-4">Website:</b><a href="{{$job->companies->website}}">&ensp;{{$job->companies->website}}</a></p>
                                    <p class="mt-2"><b class="blue-grey-text text-darken-4">Phone:</b> {{ $job->companies->phone }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            sendDataApprove: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.post('/application/detail/approval/{{$application->id}}', {
                        alasan: this.alasan,
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            title: 'Success',
                            text: 'Lamaran Disetujui',
                            icon: 'success',
                            allowOutsideClick: false,
                        }).then((result) => {
                            if (result.isConfirmed) {
                                window.location.href = '/application/detail/{{$application->id}}';
                            }
                        })
            ...
            sendDataReject: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.post('/application/detail/reject/{{$application->id}}', {
                        alasan: this.alasan,
