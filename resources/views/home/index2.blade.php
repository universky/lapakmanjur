 ...
 */
        ...
        *::after {
        ...
        body {
            ...
            background: linear-gradient(90deg, rgba(105, 100, 182, 1) 0%, rgba(79, 127, 204, 1) 43%, rgba(104, 193, 212, 1) 100%); */
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Lapak Manjur</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <?php if ($user == null) { ?>
                        <li class="nav-item"><a class="nav-link" href="/lpk/daftar">Daftar LPK</a></li>
                ...
                <div class="col-lg-8 align-self-end">
                    ...
                    <div class="tulisan">
                        <div class="flip_letters">
                            <span style="--flip:1">S</span>
                            <span style="--flip:2">e</span>
                            <span style="--flip:3">l</span>
                            <span style="--flip:4">a</span>
                            <span style="--flip:5">m</span>
                            <span style="--flip:6">a</span>
                            <span style="--flip:7">t</span>
                            <span style="--flip:8"></span>

                            <span style="--flip:1">D</span>
                            <span style="--flip:2">a</span>
                            <span style="--flip:3">t</span>
                            <span style="--flip:4">a</span>
                            <span style="--flip:5">n</span>
                            <span style="--flip:6">g</span>
                        </div>
                    </div>
                    <?php if ($user != null) { ?>
                        <p style="color: white;">{{$user->name}}</p>
                    <?php } ?>
                    <!-- <p>DISNAKER CIANJUR</p> -->
                    <hr class="divider" />
                </div>

                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">DISNAKER CIANJUR</p>
                    <!-- <a class="btn btn-primary btn-xl" href="#about">服務項目</a> -->
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">Tentang Lapak Manjur</h2>
                    <hr class="divider divider-light" />
                    <p class="text-white-75 mb-4">Kami menyediakan layanan Pengajuan AK-1 Online, Rekom Passport, serta informasi seputar Lowongan Kerja dan Pelatihan</p>
                    <a class="btn btn-light btn-xl" href="#services">Lihat Layanan</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section bg-info" id="services">
        ...
        <div class="container px-4 px-lg-5">
            <div id="particles-js"></div>
            <h2 class="text-center mt-0">Pilih Layanan</h2>
            <hr class="divider" />
                        ...
                        <div class="card" style="color: #000;">
                            <div class="card-content">
                                <div class="mt-5">
                                    ...
                                    <h3 class="h4 mb-2">AK-1 Online</h3>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="/rekom_passport">
                        <div class="card" style="color: #000;">
                            <div class="card-content">
                                <div class="mt-5">
                                    <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                                    <h3 class="h4 mb-2">Rekom Passport</h3>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="/info_pelatihan">
                        <div class="card" style="color: #000;">
                            <div class="card-content">
                                <div class="mt-5">
                                    <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                                    <h3 class="h4 mb-2">Informasi Pelatihan</h3>
                                </div>
                            </div>
                        </div>
                    </a>
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">Copyright &copy; 2022 - DISNAKER CIANJUR</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
