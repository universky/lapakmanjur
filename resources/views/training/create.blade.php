            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 l6">
                        <h5 class="breadcrumbs-title"><span>Buat Pelatihan</span></h5>
                    </div>
                    <div class="col s12 m6 l6 right-align-md">
                        <ol class="breadcrumbs mb-0">
                            <li class="breadcrumb-item"><a href="/lpk/detail/{{$id}}">Kembali</a>
                            </li>
            ...
            sendData: function() {
                ...
                axios.post('/training', {
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            title: 'Berhasil',
                            text: 'Program Pelatihan telah dibuat.',
                            icon: 'success',
                            allowOutsideClick: false,
                        }).then((result) => {
                            if (result.isConfirmed) {
                                window.location.href = '/lpk/detail/{{$id}}';
                            }
                        })
