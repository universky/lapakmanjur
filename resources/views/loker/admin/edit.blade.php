            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 l6">
                        <h5 class="breadcrumbs-title"><span>Edit Pekerjaan</span></h5>
                    </div>
...
<script>
    ...
    let app = new Vue({
        ...
        data: {
            ...
            kemampuan_wajib: '{{$job->kemampuan_wajib}}',
            kemampuan_tambahan: '{{$job->kemampuan_tambahan}}',
            deskripsi: '{{$job->deskripsi}}',
            tgl_buat: '{{$job->tgl_buat}}',
            batas_tgl: '{{$job->batas_tgl}}',
            created_at: '',
            updated_at: '',
            ...
            sendData: function() {
                ...
                axios.patch('/loker/{{$job->id}}', {
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            title: 'Berhasil',
                            text: 'Data Pekerjaan telah diperbaharui.',
                            icon: 'success',
